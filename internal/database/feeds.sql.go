...
SELECT id, created_at, updated_at, url, name, user_id, last_fetched_at from feeds where url = $1
`
...
SELECT id, created_at, updated_at, url, name, user_id, last_fetched_at FROM feeds order by last_fetched_at NULLS FIRST limit 1
`
